...
deviceinfo += ("Operater Name: " + tm.getNetworkOperator() + "\n");
...
public boolean onCreateOptionsMenu(Menu menu)
{
    ...
    menuInflater.inflate(R.layout.planmenu, menu);
     return true;
}
...
public boolean onOptionsItemSelected(MenuItem item)
{
    ...
    {
    case R.id.menu_GSM:
	    Intent myIntent = new Intent(MainActivity.this, GSMLOC.class);
	    startActivity(myIntent);
        return true; 
    case R.id.menu_SPCal:
	    myIntent = new Intent(MainActivity.this, speedcal.class);
	    startActivity(myIntent);
        return true; 
